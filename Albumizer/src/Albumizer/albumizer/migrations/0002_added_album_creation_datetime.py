...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.creationDate'
        db.add_column('albumizer_album', 'creationDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Changing field 'Album.description'
        db.alter_column('albumizer_album', 'description', self.gf('django.db.models.fields.TextField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'Album.creationDate'
        db.delete_column('albumizer_album', 'creationDate')

        # Changing field 'Album.description'
        db.alter_column('albumizer_album', 'description', self.gf('django.db.models.fields.TextField')())
