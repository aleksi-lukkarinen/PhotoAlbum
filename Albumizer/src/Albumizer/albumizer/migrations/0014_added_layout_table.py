...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Layout'
        db.create_table('albumizer_layout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key = True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique = True, max_length = 255)),
            ('imageFieldCount', self.gf('django.db.models.fields.IntegerField')(default = 0)),
            ('textFieldCount', self.gf('django.db.models.fields.IntegerField')(default = 0)),
            ('cssClass', self.gf('django.db.models.fields.CharField')(max_length = 255)),
            ('cssContent', self.gf('django.db.models.fields.TextField')(blank = True)),
        ))
        db.send_create_signal('albumizer', ['Layout'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('albumizer_layout')
