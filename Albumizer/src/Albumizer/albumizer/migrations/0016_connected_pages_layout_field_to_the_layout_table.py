...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Page.layoutID'
        db.delete_column('albumizer_page', 'layoutID')

        # Adding field 'Page.layout'
        db.add_column('albumizer_page', 'layout', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['albumizer.Layout']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Page.layoutID'
        db.add_column('albumizer_page', 'layoutID', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Page.layout'
        db.delete_column('albumizer_page', 'layout_id')
