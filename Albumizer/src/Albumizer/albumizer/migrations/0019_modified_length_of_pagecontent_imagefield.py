...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageContent.image'
        db.alter_column('albumizer_pagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'PageContent.image'
        db.alter_column('albumizer_pagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
