...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('albumizer_shoppingcartitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albumizer.Album'])),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('additionDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('albumizer', ['ShoppingCartItem'])

        # Adding unique constraint on 'ShoppingCartItem', fields ['user', 'album']
        db.create_unique('albumizer_shoppingcartitem', ['user_id', 'album_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ShoppingCartItem', fields ['user', 'album']
        db.delete_unique('albumizer_shoppingcartitem', ['user_id', 'album_id'])

        # Deleting model 'ShoppingCartItem'
        db.delete_table('albumizer_shoppingcartitem')
