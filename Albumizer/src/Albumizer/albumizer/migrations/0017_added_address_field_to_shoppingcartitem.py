...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ShoppingCartItem', fields ['album', 'user']
        db.delete_unique('albumizer_shoppingcartitem', ['album_id', 'user_id'])

        # Adding field 'ShoppingCartItem.deliveryAddress'
        db.add_column('albumizer_shoppingcartitem', 'deliveryAddress', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albumizer.Address'], null=True), keep_default=False)

        # Adding unique constraint on 'ShoppingCartItem', fields ['additionDate', 'album', 'user']
        db.create_unique('albumizer_shoppingcartitem', ['additionDate', 'album_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ShoppingCartItem', fields ['additionDate', 'album', 'user']
        db.delete_unique('albumizer_shoppingcartitem', ['additionDate', 'album_id', 'user_id'])

        # Deleting field 'ShoppingCartItem.deliveryAddress'
        db.delete_column('albumizer_shoppingcartitem', 'deliveryAddress_id')

        # Adding unique constraint on 'ShoppingCartItem', fields ['album', 'user']
        db.create_unique('albumizer_shoppingcartitem', ['album_id', 'user_id'])
