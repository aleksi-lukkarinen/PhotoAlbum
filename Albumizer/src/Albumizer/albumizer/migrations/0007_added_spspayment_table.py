...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SPSPayment'
        db.create_table('albumizer_spspayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albumizer.Order'], unique=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('transactionDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('referenceCode', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('clarification', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('albumizer', ['SPSPayment'])


    def backwards(self, orm):
        
        # Deleting model 'SPSPayment'
        db.delete_table('albumizer_spspayment')
