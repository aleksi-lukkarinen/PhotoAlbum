...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShoppingCartItem.status'
        db.delete_column('albumizer_shoppingcartitem', 'status')


    def backwards(self, orm):
        
        # Adding field 'ShoppingCartItem.status'
        db.add_column('albumizer_shoppingcartitem', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
