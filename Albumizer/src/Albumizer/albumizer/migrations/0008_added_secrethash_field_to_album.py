...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.secretHash'
        db.add_column('albumizer_album', 'secretHash', self.gf('django.db.models.fields.TextField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.secretHash'
        db.delete_column('albumizer_album', 'secretHash')
